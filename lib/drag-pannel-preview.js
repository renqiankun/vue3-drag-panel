...
const F = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  try {
    ...
    for (var o in t) {
      let n = t[o];
      if (a.test(n)) {
        let i = /\$\{(.*?)\}/g, d = ((r = n.match(i)) == null ? void 0 : r[0]) ?? "", p = n.split(d), l = d.replace(/[\$|{|}]/g, ""), c = (e == null ? void 0 : e[l]) ?? "";
        t[o] = (_ = p.join) == null ? void 0 : _.call(p, c);
      }
    }
  } catch (n) {
    ...
    return (r, _) => (f(), v("div", X, [
      (f(!0), v(I, null, T(r.data.group, (n) => (f(), v("div", {
        ...
        (f(), B(P(t(n.self.name)), H({
          ...
          "onUpdate:modelValue": (i) => r.groupModel[n.self.modelValue] = i,
          defaultModelValue: n.self.defaultModelValue,
          "onUpdate:defaultModelValue": (i) => n.self.defaultModelValue = i,
          disabled: !0
...
const K = /* @__PURE__ */ y(J, [["__scopeId", "data-v-51bcdfe3"]]), Q = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(s) {
    ...
    const _ = () => {
      let i = e.w, d = e.h;
      t.value.width = i, t.value.height = d, o ? (o = !1, r = document.createElement("img"), r.src = e.url, r.onload = () => {
        a.drawImage(r, 0, 0, i, d), n();
      }) : n();
    }, n = () => {
      const { vertical: i, horizontal: d } = e.flip ?? {};
      let p = e.w, l = e.h;
      const c = d ? -1 : 1, u = i ? -1 : 1;
      a.clearRect(0, 0, p, l), a.translate(p / 2 - p * c / 2, l / 2 - l * u / 2), a.scale(c, u), a.drawImage(r, 0, 0, p, l), a.setTransform(1, 0, 0, 1, 0, 0);
    };
    return (i, d) => (f(), v("canvas", {
      ref_key: "canvas",
      ref: t
    }, null, 512));
  }
...
const de = /* @__PURE__ */ y(re, [["__scopeId", "data-v-8f822377"]]), se = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: de
}, Symbol.toStringTag, { value: "Module" })), ue = ["innerHTML"], ie = /* @__PURE__ */ b({
  __name: "index",
  props: {
    url: {},
    color: { default: "" },
...
const E = (s) => be[`./${s}/index.vue`], ye = ["onClick"], we = b({
  ...
  setup(s, { emit: e }) {
    ...
    const r = (l) => ({
      ...
      }, c = a.value.getBoundingClientRect(), { endRate: u, translateX: h, translateY: g } = n(
        c.width,
        c.height
      );
      o.value = {
      ...
      let u = l / t.pannel.width, h = c / t.pannel.height, g = u > h ? h : u, z = u <= h ? 0 : l * g, O = h <= u ? 0 : c * g;
      return {
        endRate: g,
        translateX: z > 0 ? l / 2 - t.pannel.width / 2 * g : z,
        translateY: O > 0 ? c / 2 - t.pannel.height / 2 * g : O
      };
    }, i = (l) => E(l).default, d = (l, c) => {
      c.self.click && (console.log("click", l.target), e("click", { event: l, item: c }));
...
const S = /* @__PURE__ */ y(me, [["__scopeId", "data-v-77739b6a"]]);
S.install = (s) => {
